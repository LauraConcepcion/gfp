class Institute < ActiveRecord::Base
  attr_accessible :name, :address, :aacce_id, :phone, :email, :web, :cec, :locality, :zip, :city, :province, :fax, :holder, :type, :nature, :island, :code_import, :code_center, :accee_code, :com
